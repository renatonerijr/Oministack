...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar no caso "${incident.title}" no valor de ${value}`
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.incident}>
                ...
                <Text style={styles.incidentProperty}>De:</Text>
